...
export function DateTimePicker({
  ...
  ...props
}: DateTimePickerProps & CalendarProps & customProps) {
    ...
    <Popover open={open} onOpenChange={setOpen}>
        ...
        {renderTrigger ? (
          ...
          <div
            className={cn(
              ...
              + ' transition-colors bg-background hover:bg-accent hover:text-accent-foreground',
      ...
      <PopoverContent className="w-auto p-2">
        <div className="flex items-center justify-between">
          <div className="text-md ms-2 flex items-center cursor-pointer">
            <div className='text-sm font-semibold'>
              <span className="hover:underline" onClick={() => setMonthYearPicker(monthYearPicker === 'month' ? false : 'month')}>
                {format(month, 'MMMM')}
              </span>
              <span className="ms-2 hover:underline" onClick={() => setMonthYearPicker(monthYearPicker === 'year' ? false : 'year')}>
                {format(month, 'yyyy')}
              </span>
            </div>
