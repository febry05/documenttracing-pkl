    ...
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    <DialogTitle>Create New Project Business Type</DialogTitle>
                </DialogHeader>
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>
                                            ...
                                            <FormControl>
                                                <Input type="text" placeholder="Enter the project business type's name" {...field} minLength={3} maxLength={255} value={field.value || ''} />
                                            </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
