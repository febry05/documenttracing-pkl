...
Route::middleware('auth')->group(function () {
    ...
    //Projects
        ...
        Route::put('/projects/{project}', [ProjectController::class, 'update'])->name('projects.update')
            // ->middleware('check_permission:true,Update Project')
            ;
    ...
    //Documents
        ...
        Route::post('/projects/{project}/documents', [ProjectDocumentController::class, 'store'])->name('projects.documents.store')
            // ->middleware('check_permission:true,Create Project Document')
            ;
    ...
    // //Versions
        ...
        Route::post('/projects/{project}/documents/{document}/versions', [ProjectDocumentVersionController::class, 'store'])->name('projects.documents.versions.store')
            // ->middleware('check_permission:true,Create Project Document Version')
            ;
        ...
        Route::put('/projects/{project}/documents/{document}/versions/{version}', [ProjectDocumentVersionController::class, 'update'])->name('projects.documents.versions.update')
            // ->middleware('check_permission:true,Update Project Document Version')
            ;
        
        Route::delete('/projects/{project}/documents/{document}/versions/{version}', [ProjectDocumentVersionController::class, 'destroy'])->name('projects.documents.versions.destroy')
            // ->middleware('check_permission:true,Delete Project Document Version')
            ;
